...
class inv_category_sets(models.Model):
    ...
    category_set_code = models.CharField(max_length= 30)
    category_set_name = models.CharField(max_length= 60)
    description = models.CharField(max_length=250)
    parent_category_set_id = models.CharField(max_length=30)    #Recursive Table
    created_by = models.CharField(max_length=30)
    creation_date = models.dateTimeField()
    last_updated_by = models.CharField(max_length=30)
    last_updation_date = models.DateTimeField()
...
class inv_parties_profile(models.Model):
    ...
    local_currency_id = models.ForeignKey('fnd.fnd_currencies', on_delete=models.CASCADE)
    reporting_currency_id = models.ForeignKey('fnd.fnd_currencies', on_delete=models.CASCADE)
    created_by = models.CharField(max_length=30)
    creation_date = models.dateTimeField()
    last_updated_by = models.CharField(max_length=30)
    last_updation_date = models.DateTimeField()
