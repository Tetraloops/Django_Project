...
class fnd_state_province(models.Model):
    state_province_id = models.AutoField(primary_key=True)
    country_code = models.ForeignKey(fnd_territories, on_delete=models.CASCADE)
    state_province_code = models.CharField(max_length=10)
